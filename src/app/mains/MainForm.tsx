export default function MainPage() {
  return (
    <div className="min-h-screen bg-[#FFFCF9]">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-4 leading-tight">
              결제 순간, 당신에게 가장 유리한 선택,<br />
              <span className="text-[#5A4633]"> PicSel이 똑똑하게 알려드립니다.<br /> 
              결제 수당을 선택해보세요! </span>
            </h1>
            <p className="text-gray-600 mb-2">
              당신의 현명한 결제 파트너가 되어줄 “PicSel” <br />
              카드·페이 혜택을 한눈에 비교하고, 가장 효율적인 결제 방식을 찾아드립니다! <br />
              지금 가입하고 바로 더 많은 혜택을 경험해보세요.
              </p>
            <button className="cursor-pointer w-full md:w-auto px-26 py-3 bg-black text-[#FFFFFF] rounded hover:bg-gray-800">
             내 결제수단에 맞는 혜택 보러가기  →
            </button>
          </div>
            <div className="rounded-lg aspect-4/3 flex items-center justify-center w-full">
                <img
                  src="mainImg.jpeg"
      ...
      <section id="how-to-use" className="bg-[#FFFCF9]-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="bg-[#FFFCF9] rounded-lg p-6">
              ...
              <h3 className="font-bold text-center mb-2">설치하기</h3>
            ...
            <div className="bg-white rounded-lg p-6">
              <div className="bg-gray-200 rounded aspect-square mb-4"></div>
              <h3 className="font-bold text-center mb-2">등록하기</h3>
              <p className="text-sm text-gray-600 text-center">
            ...
            <div className="bg-[#FFFCF9] rounded-lg p-6">
              <div className="bg-gray-200 rounded aspect-square mb-4"></div>
              <h3 className="font-bold text-center mb-2">비교하기</h3>
              <p className="text-sm text-gray-600 text-center">
            ...
            <div className="bg-white rounded-lg p-6">
              <div className="bg-gray-200 rounded aspect-square mb-4"></div>
              <h3 className="font-bold text-center mb-2">사용하기</h3>
              <p className="text-sm text-gray-600 text-center">
