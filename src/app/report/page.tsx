...
// 그래프 데이터
const labels = ["00~04시", "04~08시", "08~12시", "12~16시", "16~20시", "20~24시"];

const chartData = {
  labels,
  datasets: [
    {
      data: [0, 0, 15000, 30000, 47000, 25000],
...
const chartOptions = {
  ...
  plugins: {
    ...
    tooltip: {
      enabled: true,
      callbacks: {
        label: (ctx: any) => `${ctx.raw.toLocaleString()}원`,
      },
    },
  },
};
          ...
          <section className="bg-white rounded-xl p-6 shadow-[0_0_10px_rgba(0,0,0,0.2)]">
            <div className="flex justify-between items-center mb-4">
              <div>
                ...
                <h2 className="text-2xl font-bold mt-1">1,170,000원</h2>
              </div>
